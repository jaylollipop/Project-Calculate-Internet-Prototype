...
if($('#soflow-color1').val() == 'mont'){
	var total = (y * 60) * (x)  / 1024;
	

}else {
	var total = (y * 60) * (x1 * 30) / 1024 ; 
...
if($('#soflow-color2_1').val() == 'mont1'){
	var total2 = y1 * x2 / 1024; 
	

}else {
	var total2 = (y1 * x3) * ( 30) / 1024 ; 
...
if($('#soflow-color3').val() == 'mont2'){
	var total3 = y2 * x5 / 1024; 
	

}else {
	var total3 = (y2 * x4) * ( 30) / 1024 ; 
...
if($('#soflow-color4').val() == 'mont3'){
	var total4 = y3 * x7 / 1024; 
	

}else {
	var total4 = (y3 * x6) * ( 30) / 1024 ; 
...
if($('#soflow-color5').val() == 'mont4'){
	var total5 = (y4 * 60) * (x9)  / 1024;
	

}else {
	var total5 = (y4 * 60) * (x8 * 30) / 1024 ; 
...
if($('#soflow-color6').val() == 'mont5'){
	var total6 = y5 * x11 / 1024; 
	

}else {
	var total6 = (y5 * x10) * ( 30) / 1024 ; 
	
}
/////////////////////////////////////////////////


	 var result = total + total2 + total3  + total3 + total4 + total5 + total6 ; 
